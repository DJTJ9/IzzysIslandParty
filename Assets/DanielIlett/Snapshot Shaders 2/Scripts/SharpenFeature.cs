...
{
    [DisallowMultipleRendererFeature("Snapshot Shaders 2/Sharpen")]
    ...
    sealed class SharpenRenderPass : SnapshotRenderPass
    {
        protected override string ShaderName
        {
            get { return "Hidden/SnapshotShaders2/Sharpen"; }
        }

        public SharpenRenderPass()
        {
            profilingSampler = new ProfilingSampler("SS2 - Sharpen");
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var maskHandleSettings = DrawMaskIfRequired<SharpenFeature>(renderGraph, frameData, settings, "SS2 Sharpen Local Mask");
            ...
            using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("SS2 Sharpen Copy Color", out var passData, profilingSampler))
            {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<BasicPassData>("SS2 Sharpen Main Pass", out var passData, profilingSampler))
            {
