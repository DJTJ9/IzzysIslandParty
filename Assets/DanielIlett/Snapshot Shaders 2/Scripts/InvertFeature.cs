...
{
    [DisallowMultipleRendererFeature("Snapshot Shaders 2/Invert")]
    public class InvertFeature : ScriptableRendererFeature
    {
    ...
    sealed class InvertRenderPass : SnapshotRenderPass
    {
        protected override string ShaderName
        {
            get { return "Hidden/SnapshotShaders2/Invert"; }
        }

        public InvertRenderPass()
        {
            profilingSampler = new ProfilingSampler("SS2 - Invert");
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var maskHandleSettings = DrawMaskIfRequired<InvertFeature>(renderGraph, frameData, settings, "SS2 Invert Local Mask");
            ...
            using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("SS2 Invert Copy Color", out var passData, profilingSampler))
            {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<BasicPassData>("SS2 Invert Main Pass", out var passData, profilingSampler))
            {
