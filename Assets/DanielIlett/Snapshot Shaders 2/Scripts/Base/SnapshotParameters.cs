...
namespace DanielIlett.SnapshotShaders2.URP
{
    ...
    [Serializable]
    public sealed class NoiseDisplayModeParameter : VolumeParameter<NoiseDisplayMode>
    {
        public NoiseDisplayModeParameter(NoiseDisplayMode value, bool overrideState = false) : base(value, overrideState) { }
    }
    ...
    [Serializable]
    public enum OutlineDrawingMode
    {
        OutlinesOverlay,
        OutlinesOnly,
        NeonOverlay,
    ...
    [Serializable]
    public sealed class OutlineDrawingModeParameter : VolumeParameter<OutlineDrawingMode>
    {
        public OutlineDrawingModeParameter(OutlineDrawingMode value, bool overrideState = false) : base(value, overrideState) { }
    }

    [Serializable]
    public enum OutlineAlgorithm
    {
        DepthNormalsColor,
    }

    [Serializable]
    public sealed class OutlineAlgorithmParameter : VolumeParameter<OutlineAlgorithm>
    {
        public OutlineAlgorithmParameter(OutlineAlgorithm value, bool overrideState = false) : base(value, overrideState) { }
    }
    ...
    [Serializable]
    public sealed class AfterimageModeParameter : VolumeParameter<AfterimageMode>
    {
        public AfterimageModeParameter(AfterimageMode value, bool overrideState = false) : base(value, overrideState) { }
    }
    ...
    [Serializable]
    public sealed class DitherModeParameter : VolumeParameter<DitherMode>
    {
        public DitherModeParameter(DitherMode value, bool overrideState = false) : base(value, overrideState) { }
    }
    ...
    public static class SnapshotParameterExtensions
    {
        ...
        public static ShaderTagId[] ConvertToArray(this List<LightModeType> lightModeTypes)
        {
            var lightModeArray = new ShaderTagId[lightModeTypes.Count];

            for (int i = 0; i < lightModeTypes.Count; ++i)
            {
                lightModeArray[i] = new ShaderTagId(lightModeTypes[i].Convert());
            }

            return lightModeArray;
        }
