...
{
    [DisallowMultipleRendererFeature("Snapshot Shaders 2/Color Separation")]
    public class ColorSeparationFeature : ScriptableRendererFeature
    {
        ColorSeparationRenderPass pass;

        public override void Create()
        {
            pass = new ColorSeparationRenderPass();
            name = "ColorSeparation";
        }

        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            var settings = VolumeManager.instance.stack.GetComponent<ColorSeparationSettings>();
    ...
    sealed class ColorSeparationRenderPass : SnapshotRenderPass
    {
        protected override string ShaderName
        {
            get { return "Hidden/SnapshotShaders2/ColorSeparation"; }
        }

        public ColorSeparationRenderPass()
        {
            profilingSampler = new ProfilingSampler("SS2 - Color Separation");
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var maskHandleSettings = DrawMaskIfRequired<ColorSeparationFeature>(renderGraph, frameData, settings, "SS2 Color Separation Local Mask");
            ...
            using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("SS2 Color Separation Copy Color", out var passData, profilingSampler))
            {
            ...
            using (var builder = renderGraph.AddRasterRenderPass<BasicPassData>("SS2 Color Separation Main Pass", out var passData, profilingSampler))
            {
                ...
                {
                    // Set Color Separation effect properties.
                    var settings = VolumeManager.instance.stack.GetComponent<ColorSeparationSettings>();
                    data.material.SetVector("_SeparationOffset", settings.separationOffset.value);
