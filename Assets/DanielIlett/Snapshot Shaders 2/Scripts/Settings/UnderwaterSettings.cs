...
namespace DanielIlett.SnapshotShaders2.URP
{
    ...
    public class UnderwaterSettings : SnapshotVolumeComponent
    {
        ...
        [Tooltip("The height at which caustics start disappearing (at x-component), with a smooth falloff to zero strength (at y-component).")]
        public Vector2Parameter causticsHeightThresholds = new Vector2Parameter(new Vector2(1000.0f, 1001.0f));
