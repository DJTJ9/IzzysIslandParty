...
namespace DanielIlett.SnapshotShaders2.URP.Editor
{
    public class SnapshotVolumeComponentEditor : VolumeComponentEditor
    {
        ...
        protected bool hasCheckedSubAssets = false;
        ...
        // Check whether the volume profile still contains components which require sub-assets,
        // and delete the sub-assets if not.
