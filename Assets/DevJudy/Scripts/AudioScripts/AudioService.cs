...
=======
        ...
        public void PlaySound(AudioSource _audioSource, bool _handleDeletion = true)
        {
            ...
            if (_handleDeletion)
                StopAndDeleteSoundWhenFinished(_audioSource);
        }
        ...
        /// <param name="_audioType"></param>
        /// <param name="_volume"></param>
        public void PlayRandomSound(AudioClip[] _clips, EAudioType _audioType, float _volume = 1f, bool _handleDeletion = true)
        {
            ...
            bool _fadeOut, bool _fadeIn, float _fadeSpeed = 0.2f)
        {
            ...
            while (_condition() &&  audioSource != null)
            {
        ...
        /// </summary>
        /// <param name="_audioSource"></param>
        public void StopAndDeleteSoundWhenFinished(AudioSource _audioSource)
        {
